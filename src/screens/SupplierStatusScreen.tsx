...
const styles = StyleSheet.create({
  ...
  headerBadge: {
    ...
    borderRadius: 20,
    borderWidth: 1,
    borderColor: 'rgba(201, 79, 49, 0.15)',
    marginBottom: 20,
  },
  badgeText: {
    fontSize: 14,
  ...
  statusHeader: {
    backgroundColor: 'rgba(201, 79, 49, 0.04)',
    paddingHorizontal: 24,
    paddingVertical: 40,
    alignItems: 'center',
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(201, 79, 49, 0.08)',
    position: 'relative',
    overflow: 'hidden',
  },
  iconContainer: {
  ...
  infoCard: {
    ...
    padding: 14,
    borderWidth: 1,
    borderColor: 'rgba(201, 79, 49, 0.12)',
  },
  infoCardFull: {
    width: '100%',
    backgroundColor: 'rgba(255, 255, 255, 0.85)',
  ...
  secondaryButton: {
    ...
    borderRadius: 14,
    borderWidth: 1.5,
    borderColor: 'rgba(201, 79, 49, 0.25)',
    backgroundColor: 'rgba(201, 79, 49, 0.04)',
    gap: 6,
  },
  secondaryButtonText: {
